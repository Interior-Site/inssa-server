...
CREATE TABLE USER (
	...
	USER_NICKNAME	VARCHAR(100)	NOT NULL						COMMENT '회원닉네임',
	USER_PHONE		VARCHAR(100)	NOT NULL						COMMENT '회원휴대폰번호',
	USER_PW			VARCHAR(100)	NOT NULL						COMMENT '회원비밀번호',
	USER_STATUS		VARCHAR(50)		NOT NULL	DEFAULT 'Y'			COMMENT '정상 : Y / 탈퇴 : N',
	USER_IMG		VARCHAR(300)		NULL						COMMENT '회원프로필사진경로',
	USER_REGDATE	DATE			NOT NULL	DEFAULT SYSDATE()	COMMENT '회원가입일',
	USER_QUIT		DATE				NULL						COMMENT '회원탈퇴일',
	USER_SOCIAL		VARCHAR(50)		NOT NULL						COMMENT '일반 : I / 카카오톡 : K / 네이버 : N / 구글 : G',
	USER_TYPE		VARCHAR(50)			NULL						COMMENT '일반 : G / 업체 : C / 관리자 : Z'
);
